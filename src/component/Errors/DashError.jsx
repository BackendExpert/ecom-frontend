...
const DashError = () => {
    return (
        <div className="flex flex-col items-center justify-center text-center px-6 py-16 bg-gray-50">
            {/* Error Code */}
            <h1 className="text-[8rem] md:text-[10rem] font-extrabold text-lime-600 animate-bounce drop-shadow-lg">
                501
            </h1>

            {/* Title */}
            <h2 className="mt-4 text-2xl md:text-3xl font-semibold tracking-wide text-lime-700">
